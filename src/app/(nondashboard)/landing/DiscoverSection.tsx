  ...
  return (
    ...
    >
        ...
        >
           ...
           search feature, you can quickly find the perfect home that meets all your needs. Start your search today and discover your dream rental property!
           </p>
        </motion.div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 xl:gap-16 text-black text-center">
            {[
              {
                imageSrc: "/landing-icon-wand.png",
                title: "Search for Properties",
                description: "Browse through our extensive colletion of rental properties in your desired location."
              },
              {
...
const DiscoverCard = ({
    ...
    <div className="px-4 py-12 shadow-lg rounded-lg bg-primary-50 md:h-72">
        ...
        <h3 className=",t-4 text-xl font-medium text-gray-800">{title}</h3>
